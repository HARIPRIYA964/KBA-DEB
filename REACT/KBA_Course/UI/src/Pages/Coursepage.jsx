...
const Coursepage = () => {
  ...
  return (
    ...
    <div className="max-w-4xl mx-auto p-5 ">
      ...
      <section>
      <Link to='/courses'  className="flex items-center my-5 gap-1 font-medium  " href = '/courses'>  Back to Courses</Link>
      </section>
    ...
    (<div className="flex flex-row justify-end gap-4 mr-[205px] ">
      ...
      <button  className="flex bg-red-500 hover:bg-red-600 text-white font-bold  rounded-full h-10 w-32 focus:outline-none focus:shadow-outline  justify-center items-center" onClick={confirmDelete}>Remove Course</button>
